...
import default_profile from '../../Assets/images/Capture.JPG'
      ...
      {contact ? (
        <>
          ...
          {messages.map((item, index) => (
              <div key={index}>
                <div className={`d-flex py-1 ${item.idSender === user.id ? "justify-content-end text-white": "justify-content-start text-white"}`}>
