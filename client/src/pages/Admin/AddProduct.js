        ...
        <div className="container-fluid" style={{width: "1000px",padding : "20px 50px"}}>
            <form onSubmit={(event)=> HandleOnsubmit.mutate(event)}>
                ...
                <div className="row mx-5 mt-3">
                    <input style={{backgroundColor: "#BCBCBC"}} type="text" className="form-control" placeholder="Product Name" name="name"  onChange={HandleOnChange}/>
                </div>
                <div className="row mx-5 mt-3">
                    <input style={{backgroundColor: "#BCBCBC"}} type="text" className="form-control" placeholder="desc" name="desc"  onChange={HandleOnChange}/>
                </div>
                <div className="row mx-5 mt-3" >
                    <input style={{backgroundColor: "#BCBCBC", paddingTop: "40px", paddingBottom : "40px"}} type="text" className="form-control"  placeholder="price" name="price"  onChange={HandleOnChange}/>
                </div>
                <div className="row mx-5 mt-3">
                    <input style={{backgroundColor: "#BCBCBC"}} type="text" className="form-control" id="exampleInputEmail1"  placeholder="stock" name="qty" onChange={HandleOnChange}/>
                </div>
